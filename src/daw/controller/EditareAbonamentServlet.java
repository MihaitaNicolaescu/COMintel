 ...
 */
@WebServlet("/private/editabonament")
public class EditareAbonamentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		HttpSession session = request.getSession();
			if(session.getAttribute("cod_abonament") != null) {
				...
				request.getRequestDispatcher("/WEB-INF/private/editareAbonament.jsp").forward(request, response);
			}else {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(request.getParameter("editare_abonament") != null) {
			...
			session.removeAttribute("cod_abonament");
