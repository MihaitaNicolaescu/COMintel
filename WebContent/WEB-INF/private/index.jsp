			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="POST" action="index">
						...
						<input class="form-control" type="number" min="" max="9999999999" placeholder="Telefon abonat" name="telefon_abonat" >
						<input class="form-control" type="number" min="100000000000000" max="999999999999999" placeholder="CNP abonat" name="cnp_abonat" >
						<input class="form-control" type="number" placeholder="Cod abonament detinut" name="cod_abonament_abonat" >
						<input class="form-control" id="txtDate" onfocus="(this.type='date')"  placeholder="Data incheiere contract" name="data_incheiere" >
